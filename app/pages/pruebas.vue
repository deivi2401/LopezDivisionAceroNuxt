...
<template>
  <div>
    <div class="gallery">
      <ul class="cards">
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-01.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-02.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-03.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-04.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-05.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-06.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-07.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-01.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-02.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-03.png)" />
        <li style="background-image: url(https://assets.codepen.io/16327/portrait-number-04.png)" />
